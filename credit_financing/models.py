...
# NOW USING SAME ETR SYSTEM AS SALES
# ====================================
class CreditTransaction(models.Model):
    """
    Records when you give a phone to customer under a credit company's plan
    Now uses Sale ID format to share ETR sequence with regular sales
    """
    ...
    # Transaction ID (auto-generated in Sale format: #SALE-0501)
